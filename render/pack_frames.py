...
# ещё и растягиваются.
#
# Три ширины под три класса экранов: телефон, ноутбук, широкий монитор. Чем
# крупнее плёнка, тем ниже нужное качество: артефакты сжатия делятся на то же
# растяжение, что и всё остальное. Зерно нового камня жмётся плохо, поэтому
# числа подобраны сравнением кропов, а не по привычке: на 2400 px q88 и q92
# неотличимы, а разница — пять мегабайт на плёнку.
# 1900, не 2400: канва равна ширине окна на плотность пикселей (не выше 1.5),
# и на типичном мониторе 1920 при DPR 1 она равна 1824 px. Кадр 2400 давал
# втрое большую площадь, чем нужно — а заливка кадра в видеопамять пропорциональна
# именно площади и съедала треть бюджета кадра. На экранах шире 1900 плёнка
# слегка растягивается; это дешевле, чем терять кадры на каждой прокрутке.
TARGETS = [("film", 1100, 90), ("film-hd", 1600, 93), ("film-xl", 1900, 90)]
AUX_WIDTH = 512
